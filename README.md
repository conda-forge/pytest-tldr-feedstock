...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-tldr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9242&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-tldr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-tldr` can be installed with:

```
conda install pytest-tldr
```

It is possible to list all of the versions of `pytest-tldr` available on your platform with:
